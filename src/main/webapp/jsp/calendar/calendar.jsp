                            ...
                            <table class="tables" cellpadding="1" cellspacing="0">
                                ...
                                <c:forEach items="${helperList }" var="obj">
                                    ...
                                    <td
                                            ...
                                            >
                                        <div class="dates" >
                                            <%--<c:if test="${obj.periodStart==1}"><span >经期开始</span>  </c:if>--%>
                                            <%--<c:if test="${obj.periodEnd==1}"><span >经期结束</span>  </c:if>--%>
                                            <%--<c:if test="${obj.yunStart==1}"><span >孕期开始</span>  </c:if>--%>
                                            <%--<c:if test="${obj.yunEnd==1}"><span >孕期结束</span>  </c:if>--%>
                                            ...
                                            <div style="width: 100%;height:120px;" >
                                                <span style="width: 25%;"><c:if test="${obj.periodStart==1}">经期开始</c:if></span>
                                                <span style="width: 25%;"><c:if test="${obj.periodEnd==1}">经期结束</c:if></span>
                                                <span style="width: 25%;"><c:if test="${obj.yunStart==1}">孕期开始</c:if></span>
                                                <span style="width: 25%;"><c:if test="${obj.yunEnd==1}">孕期结束</c:if></span>

                                                <span ><c:if test="${obj.yun==1}">孕期症状</c:if></span>
                                                <span ><c:if test="${obj.xiang==1}">月经详详</c:if></span>
                                                <span ><c:if test="${obj.tong==1}">同房</c:if></span>
                                                <span ><c:if test="${obj.yao==1}">避孕药</c:if></span>
                                                <br>
                                                <span ><c:if test="${obj.zhong==1}">体重</c:if></span>
                                                <span ><c:if test="${obj.zheng==1}">症状</c:if></span>
                                                <span ><c:if test="${obj.yundong==1}">运动</c:if></span>
                                                <span ><c:if test="${obj.bian==1}">排便</c:if></span>

                                                <br>
                                                <span ><c:if test="${obj.qing==1}">情绪</c:if></span>
                                                <span ><c:if test="${obj.shui==1}">睡眠</c:if></span>
                                                <span ><c:if test="${obj.ti==1}">体型记录</c:if></span>
                                                <span ><c:if test="${obj.bei==1}">备注</c:if></span>
                                                <br>
                                                <span ><c:if test="${obj.wen==1}">基础体温</c:if></span>
                                                <span ><c:if test="${obj.luan==1}">排卵试纸</c:if></span>
                                                <span ><c:if test="${obj.zao==1}">早孕试纸</c:if></span>
                                                <span ><c:if test="${obj.shou==1}">排卵日</c:if></span>
                                            </div>
                                    </td>
                                    <c:if test="${sign==7}">
                                        </tr>
