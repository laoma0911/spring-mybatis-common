...
<div class="container-fluid">
    ...
    <div class="block">
        ...
        <div class="block-content collapse in">
            <div class="span12">
                <form class="form-horizontal" id="saveCustom" name="saveCustom" action="${BasePath }/topic/exportsoftFeedExcelHotList"
...
<script>
    function checkForm() {
        ...
        var tm = lktimes - starttimes;
        
        if( (tm / 1000 / 60 / 60 / 24) > 6){
        	alert("时间最大可选7天的范围");
        	return false;
        }
