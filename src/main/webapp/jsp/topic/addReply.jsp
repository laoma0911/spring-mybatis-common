...
<div class="container-fluid">
    ...
    <div class="block">
        ...
        <div class="block-content collapse in">
            <div class="span12">
                <form class="form-horizontal" id="saveCustom" name="saveCustom" action="${BasePath }/topic/saveReply"
...
<script>
    ...
    function changeReplyUser(obj) {
        ...
        //1.$.ajax带json数据的异步请求
        var aj = $.ajax( {
            url: '${BasePath}/topic/getTopicReplyUser?kind=' + kind + "&topicId=" + topicId,
            type:'post',
            cache:false,
            dataType:'json',
