...
<div class="container-fluid">
						<div class="block">
							<div class="navbar navbar-inner block-header">
								<div class="muted pull-left">添加积分</div>
							</div>
							...
							<div class="block-content collapse in">
								<div >
									<form class="form-horizontal" id="saveAti" name="saveAti" action="${BasePath }/points/save" method="post">
										...
										<div class="control-group">
											<label class="control-label" for="title" style="float: left;">分数值：</label>
											<div class="controls">
											 	 <input class="input-xlarge focused" name="points" id="points" type="text" />
