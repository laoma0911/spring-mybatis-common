            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    <div class="block">
                        <div class="navbar navbar-inner block-header" style="border-bottom: none;">
                            <form class="form-inline" id="myForm" name="myForm" action="${BasePath}/points/reward" method="post">
                                选择期别:
				...
				<div id="fixedBar" class="navbar navbar-inner" style="clear:both;">
					<div class="muted pull-left inline">
						<pe:permission key="add">
							<button class="btn btn-danger btn-small" onclick="openModel('${BasePath}/points/addpoints?${PublicParams}','添加积分','50%','50%')">添加积分</button>
						</pe:permission>
					</div>
				</div>
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">积分奖惩列表</div>
                    </div>
