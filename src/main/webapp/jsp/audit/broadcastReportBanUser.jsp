...
<div class="container-fluid">
    ...
    <div class="block">
        ...
        <div class="block-content collapse in">
            <div class="span12">
                <form id="myDialogForm" name="myDialogForm" method="post" action="${BasePath}/broadcastReport/banUser">
                    ...
                    <input type="hidden" name="broadcastId" id="broadcastId" value="${json.broadcastId}"/>
                    <fieldset>
                        对用户<font color="#08c">${json.nick}</font>(${json.uid})的处理为:
                        <div>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                                <label class="checkbox inline">
                                    <input type="checkbox" name="isdelAll" id="isdelAll" value="1" checked="checked" >删除该用户全部语音回复
                                </label>
                            <label class="checkbox inline">
