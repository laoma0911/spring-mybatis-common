            ...
            <div class="row-fluid">
                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header" style="border-bottom: none;">
                            <form class="form-inline" id="myForm" name="myForm"
                                  action="${BasePath}/chatReport/list?${PublicParams}" method="post">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left inline">聊天室语音审核列表</div>
                    </div>
                                ...
                                <c:forEach items="${json}" var="obj">
                                    <tr>
                                        ...
                                        <td nowrap="true" class="uid">
                                            ...
                                            <a href="${BasePath }/chatReport/list?uid=${obj.uid}&type=8&itemId=146">她的全部语音信息</a><br>
                                        </td>
                                        <td nowrap="true">
                                            ...
                                            <c:if test="${status==1}">
                                                ...
                                                <pe:permission key="banUser">
                                                    <button class="btn btn-danger btn-small"
                                                            onclick="openModel('${BasePath}/chatReport/toBanUser?uid=${obj.uid}&nick=${obj.nick}&id=${obj.id}','封禁用户','45%','70%')">
                                                        封禁用户
                                                    </button>
                                                </pe:permission>
                                            </c:if>
...
<script type="text/javascript">
    ...
    function setAdutiStatus(status) {
        ...
        $.ajax({
            type: "POST",
            url: "${BasePath}/chatReport/setAdutiStatus?ids=" + ids + "&status=" + status,
            datatype: "json",
