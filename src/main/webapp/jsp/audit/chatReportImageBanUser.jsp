...
<div class="container-fluid">
    ...
    <div class="block">
        ...
        <div class="block-content collapse in">
            <div class="span12">
                <form id="myDialogForm" name="myDialogForm" method="post" action="${BasePath}/chatReportImage/banUser">
                        ...
                        <div>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                                <label class="checkbox inline">
                                    <input type="checkbox" name="isdelAll" id="isdelAll" value="1" checked="checked" >删除该用户全部语音和图片回复
                                </label>
                            <label class="checkbox inline">
...
<script>
    ...
    $("#isdelAll").attr("disabled", "disabled");
</script>