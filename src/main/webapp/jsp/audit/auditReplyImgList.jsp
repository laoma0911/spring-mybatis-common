					...
					<div class="block">
						<div class="navbar navbar-inner block-header" style="border-bottom: none;">
							<form class="form-inline" id="myForm" name="myForm"
							      action="${BasePath}/audit/replyImgList?${PublicParams}" method="post">
								...
								<c:forEach items="${topicReplyList}" var="obj">
									<tr>
										...
										<pe:permission key="banUser">
											<td style="vertical-align:middle">
											  <button class="btn btn-danger btn-small" onclick="openModel('${BasePath}/audit/toBanUser?uid=${obj.uid}&replyId=${obj.id}&nick=${obj.nick}','封禁楼主','45%','70%')">封禁用户</button>
											</td>
										</pe:permission>
									</tr>
								</c:forEach>
