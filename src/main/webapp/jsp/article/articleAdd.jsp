...
<!-- 	<script src="article.js"></script> -->
	<script src="${BasePath}/js/html5media.min.js" type="text/javascript"></script>
           ...
           editorIntro = K.create('textarea[name="article"]', {
               ...
               htmlTags: {
                   ...
                   img: ["src", "width", "height"],
           			input:['onclick','click','type','value','url','data-toggle','href','id','name','alt','data-ke-onclick','href','/'],
...
<!--                                         </div> -->
                                        ...
                                        <div class="control-group" >
                                            ...
                                            <div class="controls">
                                                <input class="input-xlarge focused" name="pic" id="pic" value="${article.pic }"   type="file" />图片为正方形
                                                <br>
