                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header" style="border-bottom: none;">
                            <form id="myForm" name="myForm" action="${BasePath}/article/list" method="post" class="form-inline">
                                <table>
                                    <tr>
                                        <td style="vertical-align: middle;">话题标题：</td>
                                        <td><input type="text" name="title" value="${title }"/></td>
                                        <td style="vertical-align: middle;">小标签：</td>
                            ...
                            <table class="table table-hover">
                                ...
                                <c:forEach items="${articleList}" var="obj">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" name="id" value="${obj.topicId}"/>
                                            <c:choose>
                                        ...
                                        <td>
                                            <c:forEach items="${obj.labelList}" var="labelObj">
                                                <a href="${BasePath}/article/list?type=${type}&itemId=${itemId}&labelId=${labelObj.id}">${labelObj.labelName}</a><br/>
                                            </c:forEach>
                                        </td>
                                        <td>
