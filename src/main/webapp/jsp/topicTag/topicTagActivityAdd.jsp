...
<div class="container-fluid">
    ...
    <div class="block">
        ...
        <div class="block-content collapse in">
            <div class="span12">
                <form class="form-horizontal" id="myForm" name="myForm" action="${BasePath }/topicTagActivity/save" enctype="multipart/form-data" method="post">
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="location" id="location">
                                    <option value="1" <c:if test="${topicTagActivity.location==1}">selected</c:if>  >位置1</option>
                                    <option value="5" <c:if test="${topicTagActivity.location==5}">selected</c:if> >位置5</option>
                                </select>
                            </div>
                        </div>
                        <%--<div class="control-group">--%>
                        ...
                        <%--<option value="${tag.id}" <c:if test="${tag.id==topicTagActivity.tagId}">selected</c:if>>${tag.tag}</option>--%>
                        <%--</c:forEach>--%>
                        <%--</select>--%>
                        <%--</div>--%>
                        <%--</div>--%>
...
<script type="text/javascript">
    $(document).ready(function () {
        setCheckBoxValue("${topicTagActivity.tagId}", "tagId");
