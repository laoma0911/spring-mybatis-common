...
<div class="container-fluid">
					...
					<div class="navbar navbar-inner block-header"  style="border-bottom: none;" >
							<br>
							<form class="form-search" name="myForm" id="myForm" action="${BasePath}/appindexad/logList" method="post">
							开始时间：
...
<%-- 									<option value="2"  <c:if test="${platform==2 }"> selected="selected"</c:if>>IOS</option> --%>
<%-- 									<option value="3"  <c:if test="${platform==3 }"> selected="selected"</c:if>>WP</option> --%>
<!-- 								</select> -->
