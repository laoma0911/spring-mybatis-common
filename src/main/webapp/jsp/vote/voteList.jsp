                ...
                <div class="span12">
                    <div class="block">
                        <div class="navbar navbar-inner block-header" style="border-bottom: none;">
                            <form id="myForm" name="myForm" action="${BasePath}/vote/list" method="post" class="form-inline">
                                <table>
                                    <tr>
                    ...
                    <div class="navbar navbar-inner block-header">
                        ...
                        <div class="pull-right">
                            <pe:permission key="add">
                                <button class="btn btn-success btn-small" onclick="openModel('${BasePath}/vote/toAdd','新增')">新增</button>
                            </pe:permission>
                        </div>
                    </div>
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <pe:permission key="update">
                                                <button class="btn btn-success btn-small" onclick="openModel('${BasePath}/vote/toModify?id=${obj.id}','修改')">修改</button>
                                            </pe:permission>
                                            <pe:permission key="delete">
                                                <button class="btn del btn-danger btn-small">删除</button>
                                            </pe:permission>
                                            <button class="btn btn-success btn-small" onclick="openModel('${BasePath}/vote/toDetail?id=${obj.id}&type=${type}&itemId=${itemId}','详情')">详情</button>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
