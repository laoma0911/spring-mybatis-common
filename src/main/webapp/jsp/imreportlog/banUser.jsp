...
<div class="container-fluid">
    ...
    <div class="block">
        <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">封禁楼主</div>
        </div>
        ...
        <div class="block-content collapse in">
            <div class="span12">
                <form id="myDialogForm" name="myDialogForm" method="post" action="${BasePath}/imReportLog/banUserSave">
                    <input type="hidden" id="type" name="type" value="${type }"/>
                    <input type="hidden" id="itemId" name="itemId" value="${itemId }"/>
                    <input type="hidden" name="topicId" id="topicId" value="${json.topicId}"/>
                    <input type="hidden" name="replyId" id="replyId" value="${json.replyId}"/>
                    <input type="hidden" name="uid" id="uid" value="${json.uid}"/>
                    <input type="hidden" name="stamp" id="stamp" value="${json.stamp}"/>
                    <input type="hidden" name="reportId" id="reportId" value="${json.reportId}"/>
                    <fieldset>
                        对用户<font color="#08c">${json.nick}</font>(${json.uid})的处理为:
<!--                         <div> -->
<!--                             &nbsp;&nbsp;&nbsp;&nbsp; -->
<%--                             <c:if test="${empty json.stamp}"> --%>
<!--                             <label class="checkbox inline"> -->
<!--                                 <input type="checkbox" name="isdel" id="isdel" onclick="checkOne(1)" value="1">删除该内容 -->
<!--                             </label> -->
<%--                             </c:if> --%>
<!--                             <label class="checkbox inline"> -->
<!--                                 <input type="checkbox" name="isdelAll" onclick="checkOne(2)" id="isdelAll" value="1">删除该用户全部帖子及回复 -->
<!--                             </label> -->

<!--                             <label class="checkbox inline"> -->
<!--                                 <input type="checkbox" name="isToMonitor" id="isToMonitor" value="1">监控楼主 -->
<!--                             </label> -->
...
<script>
    function checkOne(type){
        if(type==1){
            $("#isdelAll").removeAttr("checked");
        }else{
            $("#isdel").removeAttr("checked");
        }
    }
