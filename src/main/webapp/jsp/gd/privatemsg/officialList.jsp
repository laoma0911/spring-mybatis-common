                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header" style="border-bottom: none;">
                            <form class="form-inline" id="myForm" name="myForm"
                                  action="${BasePath}/meiyue/privateMsg/officialList?${PublicParams}" method="post">
                                UID：
...
<!--                                 </select> -->
                                ...
                                <input type="hidden" name="uidLive" id="uidLive" value="${uidLive }"/>
                            </form>
                    ...
                    <div class="navbar navbar-inner block-header">
                        ...
                        <div class="pull-right">
                            ...
                            <pe:permission key="reply">
                                <button class="btn btn-success btn-small" style="margin-top: -5px" onclick="toReply()">回复</button>
                            </pe:permission>
                        </div>
                        </div>
                                ...
                                <c:forEach items="${data}" var="obj">
                                    <tr>
                                        <td nowrap="true" id="clickId">
                                            <input type="checkbox" name="id" id="id" value="${obj.uid}"/>
                                        </td>
                                        ...
                                        <td nowrap="true" style="vertical-align:middle">
                                            <c:if test="${obj.messageType == 1}">
	                                            <textarea style="width:300px" cols="3000" rows="4">${obj.message}</textarea>
                                            </c:if>
                                        </td>
                                        ...
                                        <td nowrap="true" style="vertical-align:middle">
                                        	<button class="btn btn-success btn-small" style="margin-top: -5px" onclick="liaotian(${obj.uid},${obj.dymUid},${obj.type})">聊天</button>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
...
<script>
    ...
    function toReply() {
        ...
        openModel('${BasePath}/meiyue/privateMsg/toSend?uids='+ids,'回复','40%','60%');
    }

    function liaotian(uid,dymUid,type){
    	var nUid = 0;
    	
    	var uidLive = $("#uidLive").val();
    	if(uidLive == 0){
    		nUid = uid;
    	} else {
    		//判断一下用户还是系统用户发送
    	...
    	openModel('${BasePath}/meiyue/privateMsg/toChat?uid='+nUid,'聊天','40%','70%');
    }
