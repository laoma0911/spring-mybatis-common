            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="block">
                        <div class="navbar navbar-inner block-header" style="border-bottom: none;">
                            <form class="form-search" name="myForm" id="myForm" action="${BasePath}/stats/getChatStatsJson" method="post">
                                开始时间：
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">聊天室数据统计</div>
                    </div>
                    ...
                    <div class="block-content collapse in">
                        <script type="text/javascript">
                            ...
                            function initChart(data) {
                                $('#container').highcharts({
                                    ...
                                    xAxis: {
                                        categories: data.chat.categories
                                    },
                                    yAxis: {
                                        title: {
                                            text: ''
                                ...
                                $('#hour').highcharts({
                                    ...
                                    xAxis: {
                                        categories: data.hour.categories
                                    },
                                    yAxis: {
                                        title: {
                                            text: ''
                        ...
                        <div id="hour" style="min-width:600px;height:400px"></div>
                    </div>
                </div>
            </div>
        </div>
