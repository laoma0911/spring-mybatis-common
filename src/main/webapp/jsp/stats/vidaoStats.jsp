            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="block">
                        <div class="navbar navbar-inner block-header" style="border-bottom: none;">
                            <form class="form-search" name="myForm" id="myForm" action="${BasePath}/stats/getVidaoStatsJson" method="post">
                                开始时间：
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">视频数据统计</div>
                        ...
                        <script type="text/javascript">
                            ...
                            function initChart(data) {
                                $('#container').highcharts({
                                    ...
                                    xAxis: {
                                        categories: data.vidao.categories
                                    },
                                    yAxis: {
                                        title: {
                                            text: '人'
