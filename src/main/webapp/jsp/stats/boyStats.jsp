            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="block">
                        <div class="navbar navbar-inner block-header" style="border-bottom: none;">
                            <form class="form-search" name="myForm" id="myForm" action="${BasePath}/stats/getBoyStatsJson" method="post">
                                开始时间：
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">男生版使用情况</div>
                        ...
                        <script type="text/javascript">
                            ...
                            function initChart(data) {
                                $('#container').highcharts({
                                    ...
                                    xAxis: {
                                        categories: data.boy.categories
                                    },
                                    yAxis: {
                                        title: {
                                            text: '人'
