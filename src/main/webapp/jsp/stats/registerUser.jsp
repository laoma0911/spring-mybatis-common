	...
	<div class="row-fluid">
				...
				<div class="span12">
				  <div class="block"  >
					<div class="navbar navbar-inner block-header"  style="border-bottom: none;" >
							<form class="form-search" name="myForm" id="myForm" action="${BasePath}/stats/getRegisterUserJson" method="post">
							开始时间：
        ...
        <div class="block">
          <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">注册用户统计</div>
...
function initChart(data){
	$('#container').highcharts({
        ...
        xAxis: {
            categories: data.regUser.categories
        },
        yAxis: {
            title: {
                text: '人'
