            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="block">
                        <div class="navbar navbar-inner block-header" style="border-bottom: none;">
                            <form class="form-search" name="myForm" id="myForm" action="${BasePath}/stats/getActiveUserStatusJson" method="post">
                                开始时间：
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">活跃用户状态统计</div>
                    ...
                    <div class="block-content collapse in">
                        <script type="text/javascript">
                            ...
                            function initChart(data) {
                                $('#container').highcharts({
                                    ...
                                    xAxis: {
                                        categories: data.userStatus.categories
                                    },
                                    yAxis: {
                                        title: {
                                            text: '人'
                                    ...
                                    series: data.userStatus.series
                                });
                                $('#activeUser').highcharts({
                                    title: {
                                        text: '活跃用户统计',
                                        x: -20 //center
                                    },
                                    ...
                                    xAxis: {
                                        categories: data.activeUser.categories
                                    },
                                    yAxis: {
                                        title: {
                                            text: '人'
                        ...
                        <div id="activeUser" style="min-width:600px;height:400px"></div>
