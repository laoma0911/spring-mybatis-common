                ...
                <div class="span12">
                    <div class="block">
                        <div class="navbar navbar-inner block-header" style="border-bottom: none;">
                            <form class="form-search" name="myForm" id="myForm" action="${BasePath}/stats/getShareJson" method="post">
                                开始时间：
                                ...
                                <select name="channel" id="channel" class="input-medium search-query inline" >
                                    <option value="-1">全部</option>
                                    <option value="0">微信好友</option>
                        ...
                        <script type="text/javascript">
                            ...
                            function initChart(data) {
                                $('#container').highcharts({
                                    ...
                                    xAxis: {
                                        categories: data.share.categories
                                    },
                                    yAxis: {
                                        title: {
                                            text: ''
