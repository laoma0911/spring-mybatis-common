	...
	<div class="row-fluid">
				...
				<div class="span12">
				  <div class="block"  >
					<div class="navbar navbar-inner block-header"  style="border-bottom: none;" >
							<form class="form-search" name="myForm" id="myForm" action="${BasePath}/stats/getToolJson" method="post">
							开始时间：
        ...
        <div class="block">
          <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">健康工具统计</div>
...
function initChart(data){
	$('#container').highcharts({
        ...
        xAxis: {
            categories: data.magic.categories
        },
        yAxis: {
            title: {
                text: '人'
	...
	$('#calendar').highcharts({
        ...
        xAxis: {
            categories: data.tools.categories
        },
        yAxis: {
            title: {
                text: '人'
