				...
				<div class="span12">
				  <div class="block"  >
					<div class="navbar navbar-inner block-header"  style="border-bottom: none;" >
							<form class="form-search" name="myForm" id="myForm" action="${BasePath}/stats/getLevelJson" method="post">
...
function initChart(json){
	...
	//饼图
	    $('#ageBing').highcharts({
	        ...
	        tooltip: {
	    	    pointFormat: '{series.name}: <b>{point.percentage:.9f}%</b>'
	        },
	        plotOptions: {
	            pie: {
	                ...
	                dataLabels: {
	                    ...
	                    format: '<b>{point.name}</b>: {point.percentage:.9f} %'
	                }
	            }
	        },
	        series: [{
		  ...
		  <script type="text/javascript" src="${BasePath}/js/highcharts/modules/exporting.js"></script>
  					...
  					<div id="ageBing" style="min-width:700px;height:800px"></div>
          </div>
        </div>
      </div>
    </div>
