			...
			<div class="row-fluid">
				<div class="span12">
					<div class="block">
						<div class="navbar navbar-inner block-header" style="border-bottom: none;">
							<form action="${BasePath}/privateMsg/list?type=${type}&itemId=${itemId}" method="post" id="myform"  name="myform" class="form-search">
								用户：
				...
				<div class="block">
					<div class="navbar navbar-inner block-header">
							...
							<a   onclick="openModel('${BasePath}/privateMsg/sendResult','发送结果列表')"  class="btn btn-small btn-success"  >发送结果列表</a>
											...
											<div class="span12" style="background-color: #eee">
												...
												<div class="" >
													<ul class="pager">
													    ...
													    <li><a href="#" onclick="page('${endCursor}')">下一页</a></li>
												    </ul>
 ...
 <script type="text/javascript">
 	...
 	function abc(){
 		...
 		function addtable(obj,cId,uid,cursorTm){
 			...
 			$(obj).attr("class","info");
 			var path = "${BasePath }/privateMsg/conversation?conversationId=" + cId + "&cursorTm=" + cursorTm+"&uid="+uid;
 			$.ajax({
				async:false,
				 type:"POST",
				 url:path,
...
// 							 createdAt = createdAt.replace("T", " ").replace("Z", "");
		...
		function send2(){
		    ...
		    var path = "${BasePath }/privateMsg/send";
		    sd(path, params);
		}
